...
def upgrade() -> None:
    ...
    op.create_table(
        "movie_genres",
        sa.Column(
            "movie_id", sa.Integer(), sa.ForeignKey("movies.movie_id"), primary_key=True
        ),
        sa.Column(
            "genre_id", sa.Integer(), sa.ForeignKey("genres.genre_id"), primary_key=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "actor_id", sa.Integer(), sa.ForeignKey("actors.actor_id"), primary_key=True
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "movie_id", sa.Integer(), sa.ForeignKey("movies.movie_id"), nullable=False
        ),
        sa.Column(
